...
static void perm (register char *a, register char *e, register char *pc, int n)
{
  for (; n--; pc++, a++)
    *a = e[*pc];
}

static void crypt_main (register char *nachr_l, register char *nachr_r, register char *schl)
{
  char tmp[KS];
  register int sbval;
...
char *des_crypt (const char *wort, const char *salt)
{
